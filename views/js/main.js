...
function getAdj(x){
  "use strict";
  //Removed variable declarations from switch statement
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    for (var i = 0; i < pizzaArr.length; i++) {
      pizzaArr[i].style.width = newwidth;
    }
  }
...
//Here I removed the pizzasDiv variable from the loop as there is no need
//for the loop to call the function multiple times
